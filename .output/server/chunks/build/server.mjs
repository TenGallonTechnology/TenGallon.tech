import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, defineComponent, createElementBlock, createApp, provide, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, computed, h, isReadonly, isRef, isShallow, isReactive, toRaw, ref, mergeProps, getCurrentScope, resolveComponent, useSSRContext } from 'vue';
import { l as klona, m as defuFn, c as createError$1, h as hasProtocol, n as isScriptProtocol, j as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch$1, q as baseURL, t as createHooks, v as isEqual, x as stringifyParsedURL, y as stringifyQuery, z as parseQuery, A as toRouteMatcher, B as createRouter, C as defu } from '../nitro/nitro.mjs';
...
const LazyIcon = defineAsyncComponent(() => import('./index-BX0UDuEy.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CVKZW7qK.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D7UpSAt8.mjs'));
